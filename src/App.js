...
import {controlHandler} from "./functions"
class App extends Component {
  ...
  render(){ 
    ...
    return (
      <div className="App">
        <NumberField number={this.state.firstNumber} changeHandler={this.changeHandler} />
        ...
        this.setState((prevState)=>
          {
            ...
            return {...prevState,firstNumber:0,secondNumber:prevState.firstNumber}
          })
      }
    }
